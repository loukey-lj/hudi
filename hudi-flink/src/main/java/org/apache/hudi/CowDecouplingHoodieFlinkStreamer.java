...
import org.apache.hudi.operator.KeyedTagFileIdFunction;
 ...
 */
public class CowDecouplingHoodieFlinkStreamer extends HoodieFlinkStreamer {
  public static void main(String[] args) throws Exception {
    ...
    inputRecords.transform(InstantGenerateOperator.NAME, TypeInformation.of(HoodieRecord.class), new InstantGenerateOperator())
        ...
        .process(new KeyedTagFileIdFunction())
        .keyBy(hoodieRecord -> hoodieRecord.getCurrentLocation().getFileId())
